...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Bringing Innovation to Life through Code
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
            A Full Stack Python Developer with experience in API development, backend optimization, and modern web technologies. Skilled in Python, Django, JavaScript, and React, with a strong focus on innovative solutions, team leadership, and problem-solving. Explore my portfolio and connect with me here.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "AI is a bridge to innovation, not a shortcut to replacement"
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1-N-hLo0Aabcc_s2YnvKIqBi8xI7VH3_d/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
